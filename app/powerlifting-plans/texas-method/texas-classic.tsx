...
export default function TexasClassic() {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({ title: "德州-经典3日" });
  }, [navigation]);
  ...
  const dayConfigs = {
    monday: {
      ...
      typeBg: "#F3F0FF",
      exercises: [
        { name: "深蹲", sets: "5×5", percentage: 0.75, oneRMKey: "squat", detail: "周五强度日重量的90%" },
        { name: "卧推", sets: "5×5", percentage: 0.75, oneRMKey: "bench", detail: "周五强度日重量的90%" },
        { name: "力量翻", sets: "5×3", percentage: 0.5, oneRMKey: "deadlift", detail: "爆发力训练，从轻重量开始" },
      ],
    },
    wednesday: {
      type: "恢复日",
      ...
      typeBg: "#E8F5E9",
      exercises: [
        { name: "深蹲", sets: "5×2~3", percentage: 0.6, oneRMKey: "squat", detail: "周一容量日重量的80~90%" },
        { name: "推举", sets: "5×3", percentage: 0.6, oneRMKey: "press", detail: "周一卧推重量的90~95%" },
        { name: "力量抓", sets: "2×3~4", percentage: 0.4, oneRMKey: "deadlift", detail: "技术训练，注重速度" },
      ],
    },
    friday: {
      type: "强度日",
      ...
      typeBg: "#FFE8E8",
      exercises: [
        { name: "深蹲", sets: "1×5", percentage: 0.85, oneRMKey: "squat", detail: "比上周五增加2.5kg" },
        { name: "卧推", sets: "1×5", percentage: 0.8, oneRMKey: "bench", detail: "比上周五增加1~1.5kg" },
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Stack.Screen options={{ title: "德州-经典3日" }} />
      <KeyboardAvoidingView
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerText}>
              <Text style={styles.headerTitle}>经典 3 日计划</Text>
              <Text style={styles.headerSubtitle}>基础动作 + 奥林匹克举重，全面发展力量</Text>
            </View>
          </View>
